export default {
  ...
  targetSettings: {
    ...
    noTargetsYet: 'Es sind noch keine Ziele definiert.',
    year: 'Jahr',
  ...
  projectSettings: {
    ...
    confirmDropUser: 'Möchten Sie diesen Benutzer wirklich entfernen?',
    addUser: 'Benutzer hinzufügen',
    dropUser: 'Benutzer von Projekt entfernen',
    searchUser: 'Benutzer über Email Adresse suchen',
    serchUserShort: 'Suche Benutzer',
    addUserSuccess: 'Benuzter wurde hinzugefügt',
    dropUserSuccess: 'Benutzer wurde entfernt',
    userAlreadyExisting: 'Benutzer ist bereits vorhanden',
