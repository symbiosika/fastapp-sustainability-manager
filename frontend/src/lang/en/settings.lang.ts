export default {
  ...
  targetSettings: {
    ...
    noTargetsYet: 'No targets have been defined yet.',
    year: 'Year',
  ...
  projectSettings: {
    ...
    confirmDropUser: 'Are you sure you want to remove this user?',
    addUser: 'Add User',
    dropUser: 'Remove User',
    searchUser: 'Search user by email address',
    serchUserShort: 'Search user',
    addUserSuccess: 'User was added',
    dropUserSuccess: 'User was removed',
    userAlreadyExisting: 'User is already part of the project',
