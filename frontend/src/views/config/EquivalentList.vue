...
const formEntries: GenericFormEntry[] = [
  ...
  {
    label: t('equivalents.units.outputUnit'),
    key: 'out',
    type: 'select',
    options: [
      { label: 'kWh', value: 'kWh' },
